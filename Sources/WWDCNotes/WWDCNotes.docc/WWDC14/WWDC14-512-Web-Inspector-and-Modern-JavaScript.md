...
Web Inspector, the powerful debugging tool in WebKit, is now available to JavaScriptCore-based apps. Find out how to leverage Web Inspector in your WebKit- and JavaScriptCore-based apps on iOS andÂ OS X. Gain an overview of what's new in the JavaScript language and how to use modern JavaScript in your apps.

@Metadata {
   @TitleHeading("WWDC14")
   @PageKind(sampleCode)
   @CallToAction(url: "https://nonstrict.eu/wwdcindex/wwdc2014/512/", purpose: link, label: "Open on WWDCIndex")
