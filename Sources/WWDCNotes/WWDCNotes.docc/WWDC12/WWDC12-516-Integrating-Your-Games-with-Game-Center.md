...
Competition and reward is central to the social gaming experience. See how to adopt Game Center in your games and learn how easily you can integrate leaderboards and achievements. Dive deeper into challenges to enhance competition among friends in any game. Explore the details of game groups and see exactly how to share Game Center data between related games â€” free and paid, standard and HD, iOS and OS X.

@Metadata {
   @TitleHeading("WWDC12")
   @PageKind(sampleCode)
   @CallToAction(url: "https://nonstrict.eu/wwdcindex/wwdc2012/516/", purpose: link, label: "Open on WWDCIndex")
